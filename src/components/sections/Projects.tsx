...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    org: "University of North Texas",
    date: "2025",
    summary: "Retrieval-Augmented Generation system for intelligent document querying and knowledge retrieval.",
    bullets: [
      "Built RAG pipeline using LangChain, ChromaDB, and OpenAI/GPT models.",
      "Implemented vector embeddings for efficient document retrieval and semantic search.",
      "Created user-friendly interface for querying knowledge bases with citations.",
    ],
    impact: "Intelligent document querying",
    tech: ["Python", "LangChain", "ChromaDB", "OpenAI API", "Vector Embeddings", "Next.js"],
    links: [{ label: "GitHub", href: GITHUB, icon: "github" }],
  },
  {
    id: "ai-career-counselor",
    title: "AI Career Counselor - LLM-Powered Career Guidance System",
    type: "AI/ML",
    org: "University of North Texas",
    date: "2025",
    summary: "Intelligent career counseling system powered by Large Language Models for personalized career guidance.",
    bullets: [
      "Built multi-agent LLM system for career assessment, resume optimization, and interview preparation.",
      "Integrated real-time job market analysis using web scraping and APIs.",
      "Created personalized learning path recommendations based on user skills and career goals.",
      "Implemented chat interface with context-aware conversations and career-specific insights.",
    ],
    impact: "Personalized AI career guidance",
    tech: ["Python", "LangChain", "OpenAI GPT-4", "Vector Databases", "Streamlit", "Agentic AI"],
    links: [{ label: "GitHub", href: GITHUB, icon: "github" }],
  },
  {
    id: "sarthak-group-tuition",
    title: "Sarthak Group Tuition Website",
    type: "Full-Stack",
    org: "Sarthak Group Tuition",
    date: "2025",
    summary: "Comprehensive tuition management platform for students and tutors with online learning features.",
    bullets: [
    ...
    impact: "Full-featured tuition platform",
    tech: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Node.js", "MongoDB"],
    links: [{ label: "Live Demo", href: "https://sarthak-group-tuition-website-ayctcqaxh-milis-projects-11005038.vercel.app/", icon: "link" }],
  },
];
